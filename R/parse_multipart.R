...
#' submission. The parameters can include both text as well as binary (file) values.
...
#' values with meta data, each separated using a boundary string. This boundary string
